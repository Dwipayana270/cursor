...
const contentData = {
  dasar: {
    ...
    5: {
      ...
      exercise: {
        question:
          "Diketahui sudut p dan q saling berpelurus, p = 20°. Berapakah q?",
        options: [
    ...
    6: {
      ...
      exercise: {
        question:
          "Diketahui total siswa kelas D sebanyak 29, banyak siswa laki-laki 14 siswa. Berapakah banyak siswi perempuan?",
        options: [
    ...
    chapters: [
      {
        ...
        description: "Bentuk aljabar",
        partial: "/partials/menengah/bab4.html",
        exercise: {
      ...
      },
      {
        ...
        description: "Kesebangunan",
        partial: "/partials/menengah/bab5.html",
        exercise: {
          question:
            "Dua bangun sebangun memiliki perbandingan sisi 2:5. Jika sisi pertama 8 cm, sisi kedua adalah...",
          options: [
      ...
      },
      {
        ...
        partial: "/partials/menengah/bab6.html",
        exercise: {
  ...
  lanjut: {
    ...
    chapters: [
      {
        id: 4,
        title: "Bab 4: Aljabar dalam Kehidupan Sehari-hari",
      ...
      {
        id: 5,
        title: "Bab 5: Kesebangunan di Dunia Nyata",
      ...
      {
        id: 6,
        title: "Bab 6: Data untuk Pengambilan Keputusan",
...
const placementTests = {
  4: [
    {
      question:
        "Manakah operasi perkalian yang sesuai dengan 3 + 3 + 3 + 3 + 3?",
      options: [
    ...
    {
      question: "Bentuk yang sama dengan 3 x (3 + 4) adalah …",
      options: [
    ...
    {
      question: "Bentuk yang sama dengan 7 x 2 - 7 x 6 adalah …",
      options: [
    ...
    {
      question: "FPB dari 24 dan 12 adalah …",
      options: [
  ...
  5: [
    {
      question:
        "Diketahui sudut a dan b saling berpenyiku, a = 30 derajat, berapakah b?",
      options: [
    ...
    {
      question:
        "Diketahui sudut p dan q saling berpelurus, p = 20 derajat, berapakah q?",
      options: [
        { text: "140", correct: false },
        { text: "150", correct: false },
        { text: "160", correct: true },
    ...
    {
      question: "Bentuk yang senilai dengan ⅔ adalah…",
      options: [
    ...
    {
      question: "FPB dari 8 dan 14 adalah …",
      options: [
        { text: "2", correct: true },
  ...
  6: [
    ...
    {
      question: "Bentuk persen dari ⅖ adalah …",
      options: [
    ...
    {
      question:
        "Diketahui semua siswa memilih satu jenis buah yang berbeda, 12 siswa suka apel, 14 suka jeruk, dan 11 suka mangga. Berapakah jumlah siswa?",
      options: [
...
const evaluationTests = {
  4: [
    {
      question: "Sederhanakan bentuk aljabar: (2x + 3y) + (4x - 2y)",
      options: [
    ...
    {
      question: "Faktorkan bentuk aljabar: x² - 9",
      options: [
    ...
    {
      question: "Manakah dua bentuk aljabar yang ekuivalen?",
      options: [
        { text: "5x dengan 5x + 4", correct: false },
        { text: "-x + 1 dengan 1 - x", correct: true },
        { text: "10", correct: false },
        { text: "14", correct: false },
      ],
    },
    {
      question: "Hasil dari (x + 2)² adalah...",
      options: [
        { text: "x² + 4", correct: false },
        { text: "x² + 4x + 4", correct: true },
        { text: "x² + 2x + 4 dengan (x-2)²", correct: false },
        { text: "x² + 4x dengan x(2x + 1)", correct: false },
      ],
    },
    {
      question:
        "Sebuah persegi panjang memiliki panjang (2x + 3) cm dan lebar (x - 1) cm. Luasnya adalah...",
      options: [
  ...
  5: [
    {
      question:
        "Dua segitiga ABC dan PQR sebangun. Jika AB = 6 cm, PQ = 9 cm, dan BC = 8 cm, panjang QR adalah...",
      options: [
        { text: "10 cm", correct: false },
        { text: "12 cm", correct: false },
        { text: "16/3 cm", correct: true },
        { text: "16 cm", correct: false },
      ],
    },
    {
      question:
        "Sebuah foto berukuran 4 cm × 6 cm akan diperbesar menjadi sebangun dengan ukuran 12 cm × ... cm",
      options: [
        { text: "16 cm", correct: false },
    ...
    {
      question:
        "Pada segitiga sebangun, perbandingan sisi-sisi yang bersesuaian adalah 3:5. Jika keliling segitiga pertama 24 cm, keliling segitiga kedua adalah...",
      options: [
    ...
    {
      question:
        "Sebuah peta memiliki skala 1:250.000. Jarak dua kota di peta 8 cm, jarak sebenarnya adalah...",
      options: [
    ...
    {
      question:
        "Dua segitiga sebangun memiliki perbandingan luas 4:9. Perbandingan sisi-sisi yang bersesuaian adalah...",
      options: [
  ...
  6: [
    {
      question:
        "Dalam sebuah kelas, nilai rata-rata matematika adalah 75. Jika ada 30 siswa, jumlah nilai semua siswa adalah...",
      options: [
    ...
    {
      question: "Median dari data 5, 7, 8, 10, 12, 15, 18 adalah...",
      options: [
        { text: "8", correct: false },
        { text: "10", correct: true },
        { text: "12", correct: false },
    ...
    {
      question: "Modus dari data 2, 3, 4, 4, 5, 5, 5, 6, 7, 7 adalah...",
      options: [
        { text: "4", correct: false },
        { text: "5", correct: true },
        { text: "6", correct: false },
    ...
    {
      question:
        "Dalam survei preferensi warna, 40% menyukai merah, 30% biru, 20% hijau, dan 10% kuning. Diagram yang paling tepat adalah...",
      options: [
    ...
    {
      question: "Jangkauan dari data 12, 15, 18, 22, 25, 28, 30 adalah...",
      options: [
        { text: "12", correct: false },
